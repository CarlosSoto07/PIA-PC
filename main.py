...
#Creacion de .Zip con archivos del PIA
parser.add_argument("-z", "--zip", help="Creacion de archivo .zip con los archivos del PIA",action="store_true")
...
if __name__=="__main__":
    ...
    if parser.webScrapping:
       ...
       Imagenes(url="https://www.uanl.mx/noticias/" ,carpeta="ImagenesWeb")
        ...
        logging.info("Creacion de .zip Iniciado...")
        print("Creando zip con archivos del PIA...")
        crearZip()
        print("El archivo se ha creado con exito")
        logging.info("Creacion de .zip Terminada...")
